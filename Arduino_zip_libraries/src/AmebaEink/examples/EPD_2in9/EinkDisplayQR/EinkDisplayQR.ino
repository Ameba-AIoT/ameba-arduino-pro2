/*
 Example guide: https://ameba-doc-arduino-sdk.readthedocs-hosted.com/en/latest/ameba_pro2/amb82-mini/Example_Guides/E-Paper/Display%20User-generated%20QR%20code.html
...
void loop() {
    ...
    PrintQRCode("https://ameba-doc-arduino-sdk.readthedocs-hosted.com/en/latest/index.html");
    epd2in9.EPD_Sleep();
}
...
void PrintQRCode(const char * url) {
    ...
    epd2in9.EPD_ClearScreen_White();  // Display whole screen in white
    epd2in9.EPD_SetFrameMemory_Partial(30, 200, paint.GetImage(), paint.GetWidth(), paint.GetHeight());
