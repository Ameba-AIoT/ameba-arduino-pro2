...
namespace zbar {
     ...
     * @param buffer is the input result pointer, it will be reallocated
     * with a larger size if necessary.
     * @param buflen is input length of the result buffer.
                                    ...
                                    const char *config_string)
    {
        ...
        zbar_config_t cfg;
        int val;
        return (zbar_parse_config(config_string, &sym, &cfg, &val) || zbar_image_scanner_set_config(scanner, sym, cfg, val));
    }
