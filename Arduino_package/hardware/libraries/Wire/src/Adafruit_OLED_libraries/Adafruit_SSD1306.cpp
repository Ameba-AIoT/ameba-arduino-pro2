 ...
 *
 * These displays use I2C communicate. I2C requires 2 pins
 * (SCL+SDA) and optionally a RESET pin.
 *
...
#include "Adafruit_OLED_libraries/splash.h"
...
/*!
    ...
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!s
*/
