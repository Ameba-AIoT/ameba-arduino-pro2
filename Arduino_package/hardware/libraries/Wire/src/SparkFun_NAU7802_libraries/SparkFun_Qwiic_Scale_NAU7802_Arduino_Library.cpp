...
// performed If initialize is false, then it's up to the caller to initalize and
...
void NAU7802::setLDORampDelay(unsigned long delay) { _ldoRampDelay = delay; }
unsigned long NAU7802::getLDORampDelay() { return _ldoRampDelay; }
...
int32_t NAU7802::getReading() { return get24BitRegister(NAU7802_ADCO_B2); }
