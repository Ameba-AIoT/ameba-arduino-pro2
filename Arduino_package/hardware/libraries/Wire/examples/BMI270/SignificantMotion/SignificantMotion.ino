...
Example Guide:
https://ameba-doc-arduino-sdk.readthedocs-hosted.com/en/latest/ameba_pro2/amb82-mini/Example_Guides/I2C/BMI270%20Significant%20Motion.html
*/
...
void setup()
{
    // Start serial
    Serial.begin(115200);
    Serial.println("BMI270 Example - Significant Motion");
