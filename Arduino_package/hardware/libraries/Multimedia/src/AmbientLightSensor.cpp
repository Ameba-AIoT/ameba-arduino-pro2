...
void AmbientLightSensor::setColorThreshold(int threshold){
    if(threshold == -1){
        if(ALS_TYPE == SW_ALS) THR_GRAY_TO_COLOR = 4000;
        else THR_GRAY_TO_COLOR = 30;
    }
    else THR_GRAY_TO_COLOR = threshold;
}

void AmbientLightSensor::setGrayThreshold(int threshold){
    if(threshold == -1){
        if(ALS_TYPE == SW_ALS) THR_COLOR_TO_GRAY = 12000;
        else THR_COLOR_TO_GRAY = 15;
    }
    else THR_COLOR_TO_GRAY = threshold;
}
