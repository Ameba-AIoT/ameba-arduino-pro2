...
#define os_free(p, sz) rtw_mfree(((u8*)(p)), (sz))
#endif
#endif
#ifndef os_strdup
extern u8 *WPS_strdup(u8 *string_copy_from);
#define os_strdup(p) WPS_strdup((u8*)(p))
#endif
#ifndef os_memcpy
#define os_memcpy(d, s, n) rtw_memcpy((d), ((void*)(s)), (n))
#endif
#ifndef os_memmove
...
int os_xqueue_receive(xqueue_handle_t xQueue, void *const pvBuffer, unsigned long xTicksToWait);

void os_xqueue_delete(xqueue_handle_t xQueue);

int os_xqueue_send(xqueue_handle_t xQueue, const void *const pvItemToQueue, unsigned long xTicksToWait);
