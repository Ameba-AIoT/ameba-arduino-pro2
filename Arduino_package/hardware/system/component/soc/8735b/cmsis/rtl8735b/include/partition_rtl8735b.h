...
#ifndef _PARTITION_RTL8735B_H_
#define _PARTITION_RTL8735B_H_

#include "platform_conf_tz.h"
#include "platform_conf_sysip_tz.h"
...
*/
#define SAU_INIT_REGION0    ENABLE

/*
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START0     0x00003000      /* start address of SAU region 0 */

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END0       0x00016FFF      /* end address of SAU region 0 */
...
*/
#define SAU_INIT_REGION1    ENABLE

/*
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START1     0x1004A800

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END1       0x20001FFF
...
*/
#define SAU_INIT_REGION2    ENABLE

/*
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START2     0x20017800
...
*/
#define SAU_INIT_REGION3    ENABLE
...
*/
#define SAU_INIT_REGION4    ENABLE

/*
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START4     0x20156000      /* start address of SAU region 4 */

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END4       0x201642FF      /* end address of SAU region 4 */
...
*/
#define SAU_INIT_REGION5    ENABLE

/*
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START5     0x70000000
...
*/
#define SAU_INIT_REGION6    ENABLE
...
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END6       0x0BA7FFFF
...
*/
#define SAU_INIT_REGION7    DISABLE
...
#define CONFIG_SEC_GTIMER0_IRQ                (CONFIG_SEC_GTIMER0)
#define CONFIG_SEC_GTIMER1_IRQ                (CONFIG_SEC_GTIMER1)
#define CONFIG_SEC_GTIMER2_IRQ                (CONFIG_SEC_GTIMER2)
#define CONFIG_SEC_GTIMER3_IRQ                (CONFIG_SEC_GTIMER3)
#define CONFIG_SEC_PWM_IRQ                    (CONFIG_SEC_PWM)
#define CONFIG_SEC_ADC_IRQ                    (CONFIG_SEC_ADC)
#define CONFIG_SEC_SGPIO_IRQ                  (CONFIG_SEC_SGPIO)
#define CONFIG_SEC_UART0_IRQ                  (CONFIG_SEC_UART0)
#define CONFIG_SEC_UART1_IRQ                  (CONFIG_SEC_UART1)
#define CONFIG_SEC_UART2_IRQ                  (CONFIG_SEC_UART2)
#define CONFIG_SEC_UART3_IRQ                  (CONFIG_SEC_UART3)
#define CONFIG_SEC_BTUART_IRQ                 (CONFIG_SEC_BTUART)
#define CONFIG_SEC_I2C0_IRQ                   (CONFIG_SEC_I2C0)
#define CONFIG_SEC_I2C1_IRQ                   (CONFIG_SEC_I2C1)
#define CONFIG_SEC_I2C2_IRQ                   (CONFIG_SEC_I2C2)
#define CONFIG_SEC_I2C3_IRQ                   (CONFIG_SEC_I2C3)
#define CONFIG_SEC_SPI0_IRQ                   (CONFIG_SEC_SPI0)
#define CONFIG_SEC_SPI1_IRQ                   (CONFIG_SEC_SPI1)
#define CONFIG_SEC_HS_SPI0_IRQ                (CONFIG_SEC_HS_SPI0)
#define CONFIG_SEC_HS_SPI1_IRQ                (CONFIG_SEC_HS_SPI1)
#define CONFIG_SEC_I2S0_IRQ                   (CONFIG_SEC_I2S0)
#define CONFIG_SEC_I2S1_IRQ                   (CONFIG_SEC_I2S1)
#define CONFIG_SEC_SPORT_IRQ                  (CONFIG_SEC_SPORT)
#define CONFIG_SEC_USB_OTG_IRQ                (CONFIG_SEC_USB_OTG)
#define CONFIG_SEC_SDIOH_IRQ                  (CONFIG_SEC_SDIOH)
#define CONFIG_SEC_SDH_IRQ                    (CONFIG_SEC_SDH)
#define CONFIG_SEC_MII_IRQ                    (CONFIG_SEC_MII)
#define CONFIG_SEC_WLAN_IRQ                   (CONFIG_SEC_WLAN)
#define CONFIG_SEC_WLAN_PWR_IRQ               (CONFIG_SEC_WLAN)
#define CONFIG_SEC_WDT_WL_IRQ                 (CONFIG_SEC_WLAN)
#define CONFIG_SEC_RSA_IRQ                    (CONFIG_SEC_RSA)
#define CONFIG_SEC_ISP_IRQ                    (CONFIG_SEC_ISP)
#define CONFIG_SEC_ENC_IRQ                    (CONFIG_SEC_ENC)
#define CONFIG_SEC_VOE_IRQ                    (SET_NS_STATE)
#define CONFIG_SEC_WDT_VOE_IRQ                (CONFIG_SEC_VOE)
#define CONFIG_SEC_NN_IRQ                     (CONFIG_SEC_NN)
#define CONFIG_SEC_ECDSA_IRQ                  (CONFIG_SEC_ECDSA)
#define CONFIG_SEC_ED25519_IRQ                (CONFIG_SEC_ED25519)
#define CONFIG_SEC_TRNG_IRQ                   (CONFIG_SEC_TRNG)
#define CONFIG_SEC_FlashCtrl_IRQ              (CONFIG_SEC_FlashCtrl)
#define CONFIG_SEC_AON_IRQ                    (CONFIG_SEC_AON)
#define CONFIG_SEC_PonGPIO_IRQ                (CONFIG_SEC_PonGPIO)
#define CONFIG_SEC_SystemOn_IRQ               (CONFIG_SEC_SystemOn)
#define CONFIG_SEC_GPIO_IRQ                   (CONFIG_SEC_GPIO)
#define CONFIG_SEC_SPIC_NAND_IRQ              (CONFIG_SEC_SPIC_NAND)

// Follow Internal IPs Default Setting
#define CONFIG_SEC_GDMA0_IRQ                  (CONFIG_SEC_GDMA0)
#define CONFIG_SEC_GDMA1_IRQ                  (CONFIG_SEC_GDMA1)
#define CONFIG_SEC_SGDMA0_IRQ                 (CONFIG_SEC_SGDMA0)
#define CONFIG_SEC_SGDMA1_IRQ                 (CONFIG_SEC_SGDMA1)
#define CONFIG_SEC_Crypto_IRQ                 (CONFIG_SEC_Crypto)
#define CONFIG_SEC_SCrypto_IRQ                (CONFIG_SEC_SCrypto)
#define CONFIG_SEC_SRXI_IRQ                   (CONFIG_SEC_SRXI)
#define CONFIG_SEC_RXI_IRQ                    (CONFIG_SEC_RXI)
#define CONFIG_SEC_SRC_OCP_OUT_L_IRQ          (CONFIG_SEC_SRC_OCP_OUT_L)
#define CONFIG_SEC_OCP_OUT_L_IRQ              (CONFIG_SEC_OCP_OUT_L)
#define CONFIG_SEC_BOD_IRQ                    (CONFIG_SEC_BOD)
#define CONFIG_SEC_RTC_IRQ                    (CONFIG_SEC_RTC)
#define CONFIG_SEC_Comparator_IRQ             (CONFIG_SEC_Comparator)
#define CONFIG_SEC_Flash_SEC_IRQ              (CONFIG_SEC_Flash_SEC)
#define CONFIG_SEC_FEPHY_IRQ                  (CONFIG_SEC_FEPHY)
...
*/
#define NVIC_INIT_ITNS0_MASK        ((CONFIG_SEC_SystemOn_IRQ << SystemOn_IRQn)|\
                                     (CONFIG_SEC_GTIMER0_IRQ << TimerGroup0_IRQn)|\
                                     (CONFIG_SEC_GTIMER1_IRQ << TimerGroup1_IRQn)|\
                                     (CONFIG_SEC_GTIMER2_IRQ << TimerGroup2_IRQn)|\
                                     (CONFIG_SEC_GTIMER3_IRQ << TimerGroup3_IRQn)|\
                                     (CONFIG_SEC_GPIO_IRQ << GPIO_IRQn)|\
                                     (CONFIG_SEC_PWM_IRQ << PWM_IRQn)|\
                                     (CONFIG_SEC_ADC_IRQ << ADC_IRQn)|\
                                     (CONFIG_SEC_SGPIO_IRQ << SGPIO_IRQn)|\
                                     (CONFIG_SEC_UART0_IRQ << UART0_IRQn)|\
                                     (CONFIG_SEC_UART1_IRQ << UART1_IRQn)|\
                                     (CONFIG_SEC_UART2_IRQ << UART2_IRQn)|\
                                     (CONFIG_SEC_UART3_IRQ << UART3_IRQn)|\
                                     (CONFIG_SEC_BTUART_IRQ << BTUART_IRQn)|\
                                     (CONFIG_SEC_I2C0_IRQ << I2C0_IRQn)|\
                                     (CONFIG_SEC_I2C1_IRQ << I2C1_IRQn)|\
                                     (CONFIG_SEC_I2C2_IRQ << I2C2_IRQn)|\
                                     (CONFIG_SEC_I2C3_IRQ << I2C3_IRQn)|\
                                     (CONFIG_SEC_SPI0_IRQ << SPI0_IRQn)|\
                                     (CONFIG_SEC_SPI1_IRQ << SPI1_IRQn)|\
                                     (CONFIG_SEC_HS_SPI0_IRQ << HSPI0_IRQn)|\
                                     (CONFIG_SEC_HS_SPI1_IRQ << HSPI1_IRQn)|\
                                     (CONFIG_SEC_I2S0_IRQ << I2S0_IRQn)|\
                                     (CONFIG_SEC_I2S1_IRQ << I2S1_IRQn)|\
                                     (CONFIG_SEC_SPORT_IRQ << SPORT_IRQn)|\
                                     (CONFIG_SEC_USB_OTG_IRQ << USB_IRQn)|\
                                     (CONFIG_SEC_SDIOH_IRQ << SDIOH_IRQn)|\
                                     (CONFIG_SEC_SDH_IRQ << SDH_IRQn)|\
                                     (CONFIG_SEC_MII_IRQ << MII_IRQn)|\
                                     (CONFIG_SEC_WLAN_IRQ << WLAN_IRQn)|\
                                     (CONFIG_SEC_WLAN_PWR_IRQ << WLAN_PWR_IRQn)|\
                                     (CONFIG_SEC_RSA_IRQ << RSA_IRQn))

#if defined(CONFIG_BUILD_SECURE) && (CONFIG_BUILD_SECURE == 1)
#define NVIC_INIT_ITNS0_VAL      (0xFFFFFFFF & (NVIC_INIT_ITNS0_MASK))
#else
// Default All secure interrupt
...
*/
#define NVIC_INIT_ITNS0_OFFSET              (32)
#define NVIC_INIT_INTS1_UNUSED_OFFSET       ((FEPHY_IRQn - NVIC_INIT_ITNS0_OFFSET)+1)
#define NVIC_INIT_INTS1_UNUSED_SEC_VAL      (0xF)
#define NVIC_INIT_ITNS1_SHIFT(IRQ_num)      (IRQ_num - NVIC_INIT_ITNS0_OFFSET)
#define NVIC_INIT_ITNS1_MASK        ((CONFIG_SEC_SPIC_NAND_IRQ << NVIC_INIT_ITNS1_SHIFT(SPIC_NAND_IRQn))|\
                                     (CONFIG_SEC_GDMA0_IRQ << NVIC_INIT_ITNS1_SHIFT(GDMA0_IRQn))|\
                                     (CONFIG_SEC_GDMA1_IRQ << NVIC_INIT_ITNS1_SHIFT(GDMA1_IRQn))|\
                                     (CONFIG_SEC_Crypto_IRQ << NVIC_INIT_ITNS1_SHIFT(Crypto_IRQn))|\
                                     (CONFIG_SEC_FlashCtrl_IRQ << NVIC_INIT_ITNS1_SHIFT(FlashCtrl_IRQn))|\
                                     (CONFIG_SEC_AON_IRQ << NVIC_INIT_ITNS1_SHIFT(AON_IRQn))|\
                                     (CONFIG_SEC_ISP_IRQ << NVIC_INIT_ITNS1_SHIFT(ISP_IRQn))|\
                                     (CONFIG_SEC_ENC_IRQ << NVIC_INIT_ITNS1_SHIFT(ENC_IRQn))|\
                                     (CONFIG_SEC_VOE_IRQ << NVIC_INIT_ITNS1_SHIFT(VOE_IRQn))|\
                                     (CONFIG_SEC_NN_IRQ << NVIC_INIT_ITNS1_SHIFT(NN_IRQn))|\
                                     (CONFIG_SEC_SGDMA0_IRQ << NVIC_INIT_ITNS1_SHIFT(SGDMA0_IRQn))|\
                                     (CONFIG_SEC_SGDMA1_IRQ << NVIC_INIT_ITNS1_SHIFT(SGDMA1_IRQn))|\
                                     (CONFIG_SEC_SCrypto_IRQ << NVIC_INIT_ITNS1_SHIFT(SCrypto_IRQn))|\
                                     (CONFIG_SEC_ECDSA_IRQ << NVIC_INIT_ITNS1_SHIFT(ECDSA_IRQn))|\
                                     (CONFIG_SEC_ED25519_IRQ << NVIC_INIT_ITNS1_SHIFT(ED25519_IRQn))|\
                                     (CONFIG_SEC_SRXI_IRQ << NVIC_INIT_ITNS1_SHIFT(SRXI_IRQn))|\
                                     (CONFIG_SEC_RXI_IRQ << NVIC_INIT_ITNS1_SHIFT(RXI_IRQn))|\
                                     (CONFIG_SEC_WDT_VOE_IRQ << NVIC_INIT_ITNS1_SHIFT(WDT_VOE_IRQn))|\
                                     (CONFIG_SEC_WDT_WL_IRQ << NVIC_INIT_ITNS1_SHIFT(WDT_WL_IRQn))|\
                                     (CONFIG_SEC_SRC_OCP_OUT_L_IRQ << NVIC_INIT_ITNS1_SHIFT(SRC_OCP_OUT_L_IRQn))|\
                                     (CONFIG_SEC_OCP_OUT_L_IRQ << NVIC_INIT_ITNS1_SHIFT(OCP_OUT_L_IRQn))|\
                                     (CONFIG_SEC_PonGPIO_IRQ << NVIC_INIT_ITNS1_SHIFT(PonGPIO_IRQn))|\
                                     (CONFIG_SEC_TRNG_IRQ << NVIC_INIT_ITNS1_SHIFT(TRNG_IRQn))|\
                                     (CONFIG_SEC_BOD_IRQ << NVIC_INIT_ITNS1_SHIFT(BOD_IRQn))|\
                                     (CONFIG_SEC_RTC_IRQ << NVIC_INIT_ITNS1_SHIFT(RTC_IRQn))|\
                                     (CONFIG_SEC_Comparator_IRQ << NVIC_INIT_ITNS1_SHIFT(Comparator_IRQn))|\
                                     (CONFIG_SEC_Flash_SEC_IRQ << NVIC_INIT_ITNS1_SHIFT(Flash_SEC_IRQn))|\
                                     (CONFIG_SEC_FEPHY_IRQ << NVIC_INIT_ITNS1_SHIFT(FEPHY_IRQn))|\
                                     (NVIC_INIT_INTS1_UNUSED_SEC_VAL << NVIC_INIT_INTS1_UNUSED_OFFSET))

#if defined(CONFIG_BUILD_SECURE) && (CONFIG_BUILD_SECURE == 1)
#define NVIC_INIT_ITNS1_VAL      (0xFFFFFFFF & (NVIC_INIT_ITNS1_MASK))
#else
// Default All secure interrupt
