...
#define RETRY_COUNT 60  /* Try times */
...
typedef struct _XMODEM_COM_PORT_ {
	void *xm_port;
	u8(*poll)(void *xm_port);
	u8(*get)(void *xm_port);
	void (*put)(void *xm_port, char c);
	s32(*line_status)(void *xm_port);
...
typedef struct _XMODEM_CTRL_ {
	...
	s32 result;
	char *pXFrameBuf;
	s32(*RxFrameHandler)(char *ptr,  u32 frame_num, u32 frame_size);
	XMODEM_COM_PORT ComPort;
} XMODEM_CTRL, *PXMODEM_CTRL;

typedef s32(*RxFrameHandler_t)(char *ptr,  u32 frame_num, u32 frame_size);
