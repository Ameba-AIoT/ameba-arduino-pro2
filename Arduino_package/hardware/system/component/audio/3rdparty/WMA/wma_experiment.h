#ifndef _EXAMPLE_AUDIO_WMA_EXPERIMENT_H
#define _EXAMPLE_AUDIO_WMA_EXPERIMENT_H
static int asf_read_header(ByteIOContext* pb);
static int asf_read_stream_properties(ByteIOContext* pb);
static int parse_packet_head(ByteIOContext* pb);

#define SP_DMA_PAGE_SIZE 1024
