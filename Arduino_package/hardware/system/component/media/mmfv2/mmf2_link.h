...
#define MMIC_CMD_GET_OUT_STAT       0x50
#define MMIC_CMD_GET_OUT_STAT0      0x50
#define MMIC_CMD_GET_OUT_STAT1      0x51
#define MMIC_CMD_GET_OUT_STAT2      0x52
#define MMIC_CMD_GET_OUT_STAT3      0x53
