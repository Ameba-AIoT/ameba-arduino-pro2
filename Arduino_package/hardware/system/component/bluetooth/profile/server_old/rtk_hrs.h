...
void heart_rate_srv_callback(rtk_bt_gatts_evt_code_t event, void *data);

void heart_rate_measurement_cccd_notify(uint8_t conn_id);

rtk_bt_err_t heart_rate_srv_add(void);

void hrs_disconnect(uint8_t conn_id);
