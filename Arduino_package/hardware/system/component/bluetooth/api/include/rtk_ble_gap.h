...
typedef enum
{
    ...
    RTK_BLE_GAP_SET_DEFAULT_DATA_LEN                       = 0x02, /*!< 0x02, means default data len */
 ...
 */
typedef enum {
    RTK_BLE_CONN_FILTER_WITH_WHITELIST,     /*!< 0, filter with whitelist */
    RTK_BLE_CONN_FILTER_WITHOUT_WHITELIST,  /*!< 1, filter without whitelist */
...
typedef struct {
     ...
     * Pairing with Unit Key Not Supported error code (0x29) and 
