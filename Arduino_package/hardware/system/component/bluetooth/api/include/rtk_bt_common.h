 ...
 * @brief     Bluetooth LE profile type
 */
typedef enum {
 ...
 */
typedef enum {
    RTK_BT_LE_GAP_ACT_GET_DEVICE_ADDR = 1,
...
typedef enum {
	...
	RTK_BT_GATTC_ACT_DEATTACH_CONN,
 ...
 * @brief     RTK BT EVT Callback function type definition
...
uint16_t rtk_bt_handle_cmd(void *pcmd);
