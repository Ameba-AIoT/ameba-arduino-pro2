...
*****************************************************************************************
  * @file     rtk_bt_trx_dev.h
  * @brief    Header file for rtk bt dat transmit and recevie using ipc
  * @details  bt trx dev api.
  * @author   sherman
  * @date     2022-04-26
  * @version  v1.0
  * *************************************************************************************
  */
#ifndef _RTK_BT_TRX_DEV_H_
#define _RTK_BT_TRX_DEV_H_

/* -------------------------------- Includes -------------------------------- */
#include "rtk_bt_defs.h"
#include "bt_ipc_host_trx.h"
 ...
 */
rtk_bt_err_t rtk_bt_ipc_dev_data_hdl(bt_ipc_host_tx_message *p_ipc_msg);
 ...
 * @return 0:fail, 1:success
 */
rtk_bt_err_t rtk_bt_ipc_dev_data_send(uint32_t profile_id, uint32_t event, uint32_t sub_event, uint32_t len, uint8_t *data);

#endif /* _RTK_BT_TRX_DEV_H_ */