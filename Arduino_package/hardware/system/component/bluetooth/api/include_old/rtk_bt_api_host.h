...
*****************************************************************************************
  ...
  * *************************************************************************************
  */
#ifndef _RTK_BT_API_HOST_H_
#define _RTK_BT_API_HOST_H_
 ...
 */
rtk_bt_err_t rtk_bt_ipc_host_cmd_hdl(bt_ipc_dev_request_message *p_ipc_msg);
 ...
 * @return 0:fail, 1:success
 */
rtk_bt_err_t rtk_bt_ipc_host_cmd_send(uint32_t profile_id, uint32_t event, uint32_t sub_event, uint32_t param_num, uint32_t *param);

#endif /* _RTK_BT_API_HOST_H_ */