...
#define BT_VENDOR_CMD_SET_SCAN_CHANNEL_MAP_SUPPORT  1
...
#define HCI_VENDOR_SET_SCAN_CHANNEL_MAP         0xFCAE

#define GAP_SCANCHAN_37                          0x01  //!< scan Channel 37
#define GAP_SCANCHAN_38                          0x02  //!< scan Channel 38
#define GAP_SCANCHAN_39                          0x04  //!< scan Channel 39
#define GAP_SCANCHAN_ALL     (GAP_SCANCHAN_37 | GAP_SCANCHAN_38 | GAP_SCANCHAN_39)
...
/**
  * @brief  Set the advertising tx power for the device, or reset advertising tx power to default value. Default power: 4.5dBm
  *
...
/**
  ...
  *
  *         Set LE link tx power. Or reset link tx power to default value.  Default power: 4.5dBm
