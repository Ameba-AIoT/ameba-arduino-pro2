...
#define F_BT_LE_GAP_SCAN_FILTER_SUPPORT     (F_BT_LE_SUPPORT && 0)
...
#define F_BT_LE_5_0_SET_PHYS_SUPPORT        (F_BT_LE_5_0_SUPPORT && 0)
...
#define F_BT_LE_4_2_DATA_LEN_EXT_SUPPORT    (F_BT_LE_4_2_SUPPORT && 0)
...
#define F_BT_LE_READ_REMOTE_FEATS           (F_BT_LE_SUPPORT && 0)
