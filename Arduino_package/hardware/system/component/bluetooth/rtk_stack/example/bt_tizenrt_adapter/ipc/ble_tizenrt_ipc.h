...
} TIZENRT_CONNECTED_CALLBACK_DATA;

typedef struct
{
  trble_operation_handle handle;
  trble_data noti_data;
} TIZENRT_CLIENT_NOTIFICATION;


void bt_ipc_tizenrt_cb_dev_to_host(ble_tizenrt_evt_code_t evt_code, void *param);
