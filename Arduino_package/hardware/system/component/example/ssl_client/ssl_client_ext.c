...
#else
static const unsigned char *test_client_key = (const unsigned char *) \
		"-----BEGIN RSA PRIVATE KEY-----\r\n" \
...
static const unsigned char *test_client_cert = (const unsigned char *) \
		"-----BEGIN CERTIFICATE-----\r\n" \
...
static const unsigned char *test_ca_cert = (const unsigned char *) \
		"-----BEGIN CERTIFICATE-----\r\n" \
