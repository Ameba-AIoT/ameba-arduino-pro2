...
#ifndef _RMESH_BT_CONFIG_CONFIG_H_
#define _RMESH_BT_CONFIG_CONFIG_H_
...
/** @defgroup BT_Config_UUIDs BT Config UUIDs
  ...
  * @{
  */
#define RMESH_GATT_UUID_BT_CONFIG_PROFILE					0xFF01
#define RMESH_GATT_UUID_CHAR_BTCONFIG_READ_WRITE			0x2A0D
