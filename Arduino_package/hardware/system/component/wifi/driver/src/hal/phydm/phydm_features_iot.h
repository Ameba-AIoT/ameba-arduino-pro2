...
#define __PHYDM_FEATURES_IOT_H__
	...
	RTL8822C_SUPPORT || RTL8195B_SUPPORT || RTL8735B_SUPPORT ||\
	RTL8822E_SUPPORT)
...
#if (RTL8822B_SUPPORT || RTL8821C_SUPPORT || RTL8735B_SUPPORT)
	#define FAHM_SUPPORT
#endif
	#define NHM_SUPPORT
	#define CLM_SUPPORT

#if (RTL8197G_SUPPORT || RTL8812F_SUPPORT || RTL8735B_SUPPORT)
...
#if (RTL8735B_SUPPORT || RTL8730A_SUPPORT)
...
#define CFG_DIG_DAMPING_CHK
	     ...
	     RTL8822C_SUPPORT || RTL8814B_SUPPORT || RTL8735B_SUPPORT ||\
	     RTL8822E_SUPPORT)
