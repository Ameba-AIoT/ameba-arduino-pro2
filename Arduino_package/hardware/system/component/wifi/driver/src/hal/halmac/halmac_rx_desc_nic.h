...
#define GET_RX_DESC_BAND_SEL(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x00, 31, 1)
...
#define GET_RX_DESC_SENT_RXCMD(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x00, 30, 1)
...
#define GET_RX_DESC_FW_STS_PKT(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x00, 28, 1)
...
#define GET_RX_DESC_PKT TYPE(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x00, 25, 3)
...
#define GET_RX_DESC_AMPDU(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x00, 17, 1)
...
#define GET_RX_DESC_AMPDU_END_PKT(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x00, 16, 1)
...
#define GET_RX_DESC_TCP_CHKSUM_VLD(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x04, 23, 1)
...
#define GET_RX_DESC_TCP_CHKSUM_ERR(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x04, 20, 1)
...
#define GET_RX_DESC_EXT_SECTYPE(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x04, 7, 1)
...
#define GET_RX_DESC_BSSID_FIT(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x08, 26, 5)
...
#define GET_RX_DESC_ADDRESS_CAM_VLD(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x08, 25, 1)
...
#define GET_RX_DESC_ADDRESS_CAM(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x08, 17, 8)

#endif

#if (HALMAC_8723F_SUPPORT)

#define GET_RX_DESC_IFS_CNT0_PHY(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x08, 17, 1)
...
#define GET_RX_DESC_SW_DEC(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x08, 16, 1)
...
#define GET_RX_DESC_SEC CAM INDEX(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x08, 10, 6)
...
#define GET_RX_DESC_MAC_ID(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x08, 0, 8)
...
#define GET_RX_DESC_RXPAYLOAD_MATCH(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x0C, 28, 1)
...
#define GET_RX_DESC_BSSID_FIT_L(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x0C, 12, 2)
...
#define GET_RX_DESC_BSSID_FIT_H(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x0C, 7, 3)
...
#define GET_RX_DESC_FREERUN_CNT(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x0C, 0, 32)

/*RXDESC_WORD4*/

#define GET_RX_DESC_RKT TYPE(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x10, 30, 2)
...
#define GET_RX_DESC_MACID_RPT_BUFF(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x10, 17, 7)

#endif

#if (HALMAC_8814A_SUPPORT || HALMAC_8822B_SUPPORT || HALMAC_8197F_SUPPORT || HALMAC_8821C_SUPPORT || HALMAC_8198F_SUPPORT || HALMAC_8822C_SUPPORT || HALMAC_8197G_SUPPORT || HALMAC_8812F_SUPPORT || HALMAC_8735B_SUPPORT)

#define GET_RX_DESC_RX_PRE_NDP_VLD(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x10, 16, 1)

#endif

#if (HALMAC_8723F_SUPPORT)

#define GET_RX_DESC_RX_PRE_NDP_OK(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x10, 16, 1)
...
#define GET_RX_DESC_TXRPTMID_CTL_MASK(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x10, 6, 1)

#endif

#if (HALMAC_8723F_SUPPORT)

#define GET_RX_DESC_TXRPT_MID_CTL_MASK(rxdesc)    LE_BITS_TO_4BYTE(rxdesc + 0x10, 6, 1)
