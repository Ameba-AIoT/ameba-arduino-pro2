...
extern const struct btc_chip_para btc_chip_para_8730a;
void halbtc8730a_chip_setup(struct btc_coexist *btc, u8 type);
void halbtc8730a_cfg_init(struct btc_coexist *btc);
void halbtc8730a_cfg_ant_switch(struct btc_coexist *btc);
void halbtc8730a_cfg_gnt_debug(struct btc_coexist *btc);
void halbtc8730a_cfg_fre_type(struct btc_coexist *btc);
