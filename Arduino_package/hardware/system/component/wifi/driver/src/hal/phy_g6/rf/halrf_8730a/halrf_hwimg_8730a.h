 ...
 *
 *****************************************************************************/
#ifndef _HALRF_HW_IMG_8730A_H_
#define _HALRF_HW_IMG_8730A_H_
#ifdef RF_8730A_SUPPORT

#define DONT_CARE_8730A	0xff

#define IF_8730A	0x8
#define ELSE_IF_8730A	0x9
#define ELSE_8730A	0xa
#define END_8730A	0xb
#define CHK_8730A	0x4
...
#endif
void halrf_config_8730a_nctl_reg(struct rf_info *rf);
void halrf_config_8730a_radio_a_reg(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8730a_store_power_by_rate(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8730a_store_power_limit(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8730a_store_power_limit_ru(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8730a_store_pwr_track(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8730a_store_xtal_track(struct rf_info *rf, enum phl_phy_idx phy);

u32 halrf_get_8730a_nctl_reg_ver(void);
u32 halrf_get_8730a_radio_reg_ver(void);

void halrf_config_8730a_radio_to_fw(struct rf_info *rf);

#endif
#endif /*  _HALRF_HW_IMG_8730A_H_ */
