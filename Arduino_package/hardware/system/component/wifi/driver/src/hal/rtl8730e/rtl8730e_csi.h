 ...
 *
 *****************************************************************************/
#ifndef __RTL8730E_CSI_H__
#define __RTL8730E_CSI_H__
...
void rtl8730e_csi_deinit(_adapter *padapter);
s32 rtl8730e_csi_en(_adapter *padapter, rtw_csi_action_parm_t *act_param);
s32 rtl8730e_csi_cfg(_adapter *padapter, rtw_csi_action_parm_t *act_param);
s32 rtl8730e_csi_report(_adapter *padapter, u32 buf_len, u8 *csi_buf, u32 *len, rtw_csi_header_t *csi_hdr);
void rtl8730e_csi_pkt_hdl(_adapter *padapter, u8 *buf, struct rtw_csi_desc *csi_desc);
#endif /* CONFIG_CSI */
