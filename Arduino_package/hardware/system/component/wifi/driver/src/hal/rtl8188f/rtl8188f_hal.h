...
VOID Hal_EfuseParseICRealVersion_8188F(PADAPTER pAdapter, u8 *hwinfo, BOOLEAN AutoLoadFail);
...
extern s32  rtl8188f_interrupt_handler(PADAPTER padapter);
extern void rtl8188f_read_chip_version(PADAPTER padapter);
extern void UpdateHalRAMask8188F(PADAPTER padapter, u32 mac_id, u8 rssi_level);
...
void rtl8188f_recv_tasklet(void *priv);
void rtl8188f_free_hal_data(_adapter *padapter);
...
void rtl8188f_GetHalODMVar(
	PADAPTER				Adapter,
	HAL_ODM_VARIABLE		eVariable,
	PVOID					pValue1,
	PVOID					pValue2);
void rtl8188f_SetHalODMVar(
	PADAPTER				Adapter,
	HAL_ODM_VARIABLE		eVariable,
	PVOID					pValue1,
	BOOLEAN					bSet);
