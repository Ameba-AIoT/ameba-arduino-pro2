#ifndef REALTEK_POWER_SEQUENCE_RTL8730E
#define REALTEK_POWER_SEQUENCE_RTL8730E
...
/*
	...
	TRANS_END
*/
#define	RTL8730E_TRANS_CARDEMU_TO_ACT_STEPS	5
#define	RTL8730E_TRANS_ACT_TO_CARDEMU_STEPS	5
#define	RTL8730E_TRANS_CARDEMU_TO_SUS_STEPS	7
#define	RTL8730E_TRANS_SUS_TO_CARDEMU_STEPS	15
#define	RTL8730E_TRANS_CARDEMU_TO_PDN_STEPS	15
#define	RTL8730E_TRANS_PDN_TO_CARDEMU_STEPS	15
#define	RTL8730E_TRANS_ACT_TO_LPS_STEPS		15
#define	RTL8730E_TRANS_LPS_TO_ACT_STEPS		15
#define	RTL8730E_TRANS_ACT_TO_SWLPS_STEPS		22
#define	RTL8730E_TRANS_SWLPS_TO_ACT_STEPS		15
#define	RTL8730E_TRANS_END_STEPS		1

#define RTL8730E_TRANS_CARDEMU_TO_ACT 														\
	/* format */																\
...
#define RTL8730E_TRANS_ACT_TO_CARDEMU													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8730E_TRANS_CARDEMU_TO_SUS													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8730E_TRANS_SUS_TO_CARDEMU													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8730E_TRANS_CARDEMU_TO_CARDDIS													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\

#define RTL8730E_TRANS_CARDDIS_TO_CARDEMU													\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\


#define RTL8730E_TRANS_CARDEMU_TO_PDN												\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
	{0x0023, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_SDIO_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT4, BIT4}, /*0x23[4] = 1b'1 12H LDO enter sleep mode*/   \
...
#define RTL8730E_TRANS_PDN_TO_CARDEMU												\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
	{0x0005, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT7, 0},/* 0x04[15] = 0*/

#define RTL8730E_TRANS_ACT_TO_LPS														\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8730E_TRANS_LPS_TO_ACT															\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8730E_TRANS_ACT_TO_SWLPS														\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8730E_TRANS_SWLPS_TO_ACT															\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
...
#define RTL8730E_TRANS_END															\
	/* format */																\
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value }, // comments here*/								\
	{0xFFFF, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,0,PWR_CMD_END, 0, 0}, //


extern const WLAN_PWR_CFG rtl8730E_power_on_flow[RTL8730E_TRANS_CARDEMU_TO_ACT_STEPS + RTL8730E_TRANS_END_STEPS];
extern const WLAN_PWR_CFG rtl8730E_radio_off_flow[RTL8730E_TRANS_ACT_TO_CARDEMU_STEPS + RTL8730E_TRANS_END_STEPS];
extern const WLAN_PWR_CFG rtl8730E_card_disable_flow[RTL8730E_TRANS_ACT_TO_CARDEMU_STEPS + RTL8730E_TRANS_CARDEMU_TO_PDN_STEPS + RTL8730E_TRANS_END_STEPS];
extern const WLAN_PWR_CFG rtl8730E_card_enable_flow[RTL8730E_TRANS_ACT_TO_CARDEMU_STEPS + RTL8730E_TRANS_CARDEMU_TO_PDN_STEPS + RTL8730E_TRANS_END_STEPS];
extern const WLAN_PWR_CFG rtl8730E_suspend_flow[RTL8730E_TRANS_ACT_TO_CARDEMU_STEPS + RTL8730E_TRANS_CARDEMU_TO_SUS_STEPS + RTL8730E_TRANS_END_STEPS];
extern const WLAN_PWR_CFG rtl8730E_resume_flow[RTL8730E_TRANS_ACT_TO_CARDEMU_STEPS + RTL8730E_TRANS_CARDEMU_TO_SUS_STEPS + RTL8730E_TRANS_END_STEPS];
extern const WLAN_PWR_CFG rtl8730E_hwpdn_flow[RTL8730E_TRANS_ACT_TO_CARDEMU_STEPS + RTL8730E_TRANS_CARDEMU_TO_PDN_STEPS + RTL8730E_TRANS_END_STEPS];
extern const WLAN_PWR_CFG rtl8730E_enter_lps_flow[RTL8730E_TRANS_ACT_TO_LPS_STEPS + RTL8730E_TRANS_END_STEPS];
extern const WLAN_PWR_CFG rtl8730E_leave_lps_flow[RTL8730E_TRANS_LPS_TO_ACT_STEPS + RTL8730E_TRANS_END_STEPS];
extern const WLAN_PWR_CFG rtl8730E_enter_swlps_flow[RTL8730E_TRANS_ACT_TO_SWLPS_STEPS + RTL8730E_TRANS_END_STEPS];
extern const WLAN_PWR_CFG rtl8730E_leave_swlps_flow[RTL8730E_TRANS_SWLPS_TO_ACT_STEPS + RTL8730E_TRANS_END_STEPS];
#endif
