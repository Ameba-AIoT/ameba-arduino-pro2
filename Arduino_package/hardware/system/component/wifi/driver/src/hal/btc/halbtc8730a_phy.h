#ifndef __INC_HALBTC8730A_PHY_H
#define __INC_HALBTC8730A_PHY_H
#include <bt_intf.h>
/**
  ...
  */
u32 btc_set_gnt_bt_8730a(pta_type_t gnt_bt);
...
/**
  ...
  * @retval SUCESS or FAIL
  */
u32 btc_set_gnt_bt_with_clk_source_8730a(pta_type_t gnt_bt);
