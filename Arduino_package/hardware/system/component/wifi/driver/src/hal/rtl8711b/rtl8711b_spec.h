 ...
 *
 *******************************************************************************/
#ifndef __RTL8711B_SPEC_H__
#define __RTL8711B_SPEC_H__
...
#define REG_HMEBOX_EXT0_8711B			0x01F0
#define REG_HMEBOX_EXT1_8711B			0x01F4
#define REG_HMEBOX_EXT2_8711B			0x01F8
#define REG_HMEBOX_EXT3_8711B			0x01FC
...
//====================================================
//			EEPROM/Efuse PG Offset for 8711B
//====================================================
// 0x10 ~ 0x63 = TX power area.
#define	EEPROM_TX_PWR_INX_8711B				0x20
#define	EEPROM_ChannelPlan_8711B			0xC8
#define	EEPROM_XTAL_8711B					0xC9
#define	EEPROM_THERMAL_METER_8711B			0xCA

#define	EEPROM_IQK_LCK_8711B				0xCB
#define	EEPROM_2G_5G_PA_TYPE_8711B			0xCC
#define	EEPROM_2G_LNA_TYPE_GAIN_SEL_8711B	0xCD
#define	EEPROM_5G_LNA_TYPE_GAIN_SEL_8711B	0xCE

#define	EEPROM_RF_BOARD_OPTION_8711B		0x131

#define	EEPROM_FEATURE_OPTION_8711B			0x132
#define	EEPROM_RF_BT_SETTING_8711B			0x133

#define	EEPROM_VERSION_8711B				0x134
#define	EEPROM_CustomID_8711B				0x135

#define	EEPROM_TX_BBSWING_2G_8711B			0x136
#define	EEPROM_TX_PWR_CAL_RATE_8711B		0x138
#define	EEPROM_RF_ANTENNA_OPT_8711B			0x139
#define	EEPROM_RFE_OPTION_8711B				0x13A
...
#define	EEPROM_Default_ThermalMeter_8711B		0x1A


#define EEPROM_Default_CrystalCap				0x0
#define EEPROM_Default_CrystalCap_8723B			0x20
#define EEPROM_Default_CrystalCap_8711B			0x20
