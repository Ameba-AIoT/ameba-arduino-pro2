...
#endif
void halrf_config_8720e_nctl_reg(struct rf_info *rf);
void halrf_config_8720e_radio_a_reg(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8720e_store_power_by_rate(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8720e_store_power_limit(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8720e_store_power_limit_ru(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8720e_store_pwr_track(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8720e_store_xtal_track(struct rf_info *rf, enum phl_phy_idx phy);

u32 halrf_get_8720e_nctl_reg_ver(void);
u32 halrf_get_8720e_radio_reg_ver(void);

void halrf_config_8720e_radio_to_fw(struct rf_info *rf);
