...
#define MAX_RECVBUF_SZ	1500//(RX_DMA_SIZE_8730A - RX_DMA_RESERVED_SIZE_8730A)
#else
#if (SKB_PRE_ALLOCATE_RX==1)
#define MAX_RECVBUF_SZ	MAX_SKB_BUF_SIZE //1650 //(RX_DMA_SIZE_8730A - RX_DMA_RESERVED_SIZE_8730A)
#else
...
#define GET_RX_STATUS_DESC_DRVINFO_SIZE(__pRxStatusDesc)		LE_BITS_TO_4BYTE( __pRxStatusDesc, 16, 4)
...
#define GET_RX_STATUS_DESC_PHY_STATUS(__pRxStatusDesc)			LE_BITS_TO_4BYTE( __pRxStatusDesc, 26, 1)
#define GET_RX_STATUS_DESC_SWDEC(__pRxStatusDesc)				LE_BITS_TO_4BYTE( __pRxStatusDesc, 27, 1)
#define GET_RX_STATUS_DESC_SENT_RXCMD(__pRxStatusDesc)		LE_BITS_TO_4BYTE( __pRxStatusDesc, 30, 1)
...
s32 rtl8730a_init_recv_priv(PADAPTER padapter);
void rtl8730a_free_recv_priv(PADAPTER padapter);
void rtl8730a_query_rx_desc_status(union recv_frame *precvframe, u8 *pdesc);
void rtl8730a_query_rx_phy_status(union recv_frame	*precvframe, u8 *pphy_status);
