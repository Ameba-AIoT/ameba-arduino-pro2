 ...
 *
 ******************************************************************************/
#ifndef __RTL8711B_DM_H__
#define __RTL8711B_DM_H__
enum {
	UP_LINK,
	DOWN_LINK,
};
...
void rtl8711b_init_dm_priv(PADAPTER padapter);
void rtl8711b_phy_dm_timer_cancel(PADAPTER padapter);

void rtl8711b_InitHalDm(PADAPTER padapter);
void rtl8711b_HalDmWatchDog(PADAPTER padapter);
