...
#define	LOK_delay_8821C 10	//Just for Rockchip platform, because its tick is 10ms, other platform defines 2
#define	GS_delay_8821C 10	//Just for Rockchip platform, because its tick is 10ms, other platform defines 2
#define	WBIQK_delay_8821C 10	//Just for Rockchip platform, because its tick is 10ms, other platform defines 2
