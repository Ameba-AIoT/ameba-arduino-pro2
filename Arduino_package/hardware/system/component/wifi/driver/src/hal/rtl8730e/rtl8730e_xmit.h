 ...
 *
 ******************************************************************************/
#ifndef __RTL8730E_XMIT_H__
#define __RTL8730E_XMIT_H__
...
#define GET_FIX_RATE_8730E(v)		((v) & 0x0FFF)
#define GET_FIX_RATE_SGI_8730E(v)	(((v) & 0x7000) >> 12)

void rtl8730e_update_txdesc(struct xmit_frame *pxmitframe, u8 *pmem);
void rtl8730e_fill_fake_txdesc(PADAPTER padapter, u8 *pDesc, u32 BufferLen, u8 IsPsPoll, u8 IsBTQosNull, u8 bDataFrame);
#ifdef CONFIG_MP_INCLUDED
void rtl8730e_prepare_mp_txdesc(PADAPTER adapter, struct mp_priv *pmp_priv);
#endif

s32 rtl8730ed_init_xmit_priv(PADAPTER padapter);
void rtl8730ed_free_xmit_priv(PADAPTER padapter);
s32	rtl8730ed_hal_xmit(_adapter *padapter, struct xmit_frame *pxmitframe);
s32 rtl8730ed_mgnt_xmit(_adapter *padapter, struct xmit_frame *pmgntframe);
s32	rtl8730ed_hal_xmitframe_enqueue(_adapter *padapter, struct xmit_frame *pxmitframe);
void rtl8730e_xmitframe_resume(_adapter *padapter);
u32 GetDmaTxbdIdx(u32 ff_hwaddr);
struct xmit_buf *rtl8730e_dequeue_xmitbuf(struct rtw_tx_ring	*ring);
