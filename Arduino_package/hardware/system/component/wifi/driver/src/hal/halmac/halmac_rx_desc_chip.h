...
#define GET_RX_DESC_SENT_RXCMD_8723F(rxdesc)    GET_RX_DESC_SENT_RXCMD(rxdesc)
#define GET_RX_DESC_FW_STS_PKT_8723F(rxdesc)    GET_RX_DESC_FW_STS_PKT(rxdesc)
#define GET_RX_DESC_SWDEC_8723F(rxdesc)    GET_RX_DESC_SWDEC(rxdesc)
#define GET_RX_DESC_PHYST_8723F(rxdesc)    GET_RX_DESC_PHYST(rxdesc)
#define GET_RX_DESC_SHIFT_8723F(rxdesc)    GET_RX_DESC_SHIFT(rxdesc)
#define GET_RX_DESC_QOS_8723F(rxdesc)    GET_RX_DESC_QOS(rxdesc)
#define GET_RX_DESC_SECURITY_8723F(rxdesc)    GET_RX_DESC_SECURITY(rxdesc)
#define GET_RX_DESC_DRV_INFO_SIZE_8723F(rxdesc)    GET_RX_DESC_DRV_INFO_SIZE(rxdesc)
#define GET_RX_DESC_ICV_ERR_8723F(rxdesc)    GET_RX_DESC_ICV_ERR(rxdesc)
#define GET_RX_DESC_CRC32_8723F(rxdesc)    GET_RX_DESC_CRC32(rxdesc)
#define GET_RX_DESC_PKT_LEN_8723F(rxdesc)    GET_RX_DESC_PKT_LEN(rxdesc)

/*RXDESC_WORD1*/

#define GET_RX_DESC_BC_8723F(rxdesc)    GET_RX_DESC_BC(rxdesc)
#define GET_RX_DESC_MC_8723F(rxdesc)    GET_RX_DESC_MC(rxdesc)
#define GET_RX_DESC_TY_PE_8723F(rxdesc)    GET_RX_DESC_TY_PE(rxdesc)
#define GET_RX_DESC_MF_8723F(rxdesc)    GET_RX_DESC_MF(rxdesc)
#define GET_RX_DESC_MD_8723F(rxdesc)    GET_RX_DESC_MD(rxdesc)
#define GET_RX_DESC_PWR_8723F(rxdesc)    GET_RX_DESC_PWR(rxdesc)
#define GET_RX_DESC_PAM_8723F(rxdesc)    GET_RX_DESC_PAM(rxdesc)
#define GET_RX_DESC_CHK_VLD_8723F(rxdesc)    GET_RX_DESC_CHK_VLD(rxdesc)
#define GET_RX_DESC_RX_IS_TCP_UDP_8723F(rxdesc)    GET_RX_DESC_RX_IS_TCP_UDP(rxdesc)
#define GET_RX_DESC_RX_IPV_8723F(rxdesc)    GET_RX_DESC_RX_IPV(rxdesc)
#define GET_RX_DESC_CHKERR_8723F(rxdesc)    GET_RX_DESC_CHKERR(rxdesc)
#define GET_RX_DESC_PAGGR_8723F(rxdesc)    GET_RX_DESC_PAGGR(rxdesc)
#define GET_RX_DESC_RXID_MATCH_8723F(rxdesc)    GET_RX_DESC_RXID_MATCH(rxdesc)
#define GET_RX_DESC_AMSDU_8723F(rxdesc)    GET_RX_DESC_AMSDU(rxdesc)
#define GET_RX_DESC_MACID_VLD_8723F(rxdesc)    GET_RX_DESC_MACID_VLD(rxdesc)
#define GET_RX_DESC_TID_8723F(rxdesc)    GET_RX_DESC_TID(rxdesc)
#define GET_RX_DESC_EXT_SECTYPE_8723F(rxdesc)    GET_RX_DESC_EXT_SECTYPE(rxdesc)
#define GET_RX_DESC_MACID_8723F(rxdesc)    GET_RX_DESC_MACID(rxdesc)

/*RXDESC_WORD2*/

#define GET_RX_DESC_FCS_OK_8723F(rxdesc)    GET_RX_DESC_FCS_OK(rxdesc)
#define GET_RX_DESC_PPDU_CNT_8723F(rxdesc)    GET_RX_DESC_PPDU_CNT(rxdesc)
#define GET_RX_DESC_C2H_8723F(rxdesc)    GET_RX_DESC_C2H(rxdesc)
#define GET_RX_DESC_RXMAGPKT_8723F(rxdesc)    GET_RX_DESC_RXMAGPKT(rxdesc)
#define GET_RX_DESC_WLANHD_IV_LEN_8723F(rxdesc)    GET_RX_DESC_WLANHD_IV_LEN(rxdesc)
#define GET_RX_DESC_IFS_CNT0_PHY_8723F(rxdesc)    GET_RX_DESC_IFS_CNT0_PHY(rxdesc)
#define GET_RX_DESC_RX_IS_QOS_8723F(rxdesc)    GET_RX_DESC_RX_IS_QOS(rxdesc)
#define GET_RX_DESC_FRAG_8723F(rxdesc)    GET_RX_DESC_FRAG(rxdesc)
#define GET_RX_DESC_SEQ_8723F(rxdesc)    GET_RX_DESC_SEQ(rxdesc)

/*RXDESC_WORD3*/

#define GET_RX_DESC_MAGIC_WAKE_8723F(rxdesc)    GET_RX_DESC_MAGIC_WAKE(rxdesc)
#define GET_RX_DESC_UNICAST_WAKE_8723F(rxdesc)    GET_RX_DESC_UNICAST_WAKE(rxdesc)
#define GET_RX_DESC_PATTERN_MATCH_8723F(rxdesc)    GET_RX_DESC_PATTERN_MATCH(rxdesc)
#define GET_RX_DESC_DMA_AGG_NUM_8723F(rxdesc)    GET_RX_DESC_DMA_AGG_NUM(rxdesc)
#define GET_RX_DESC_BSSID_FIT_L_8723F(rxdesc)    GET_RX_DESC_BSSID_FIT_L(rxdesc)
#define GET_RX_DESC_EOSP_8723F(rxdesc)    GET_RX_DESC_EOSP(rxdesc)
#define GET_RX_DESC_HTC_8723F(rxdesc)    GET_RX_DESC_HTC(rxdesc)
#define GET_RX_DESC_BSSID_FIT_H_8723F(rxdesc)    GET_RX_DESC_BSSID_FIT_H(rxdesc)
#define GET_RX_DESC_RX_RATE_8723F(rxdesc)    GET_RX_DESC_RX_RATE(rxdesc)

/*RXDESC_WORD4*/

#define GET_RX_DESC_A1_FIT_8723F(rxdesc)    GET_RX_DESC_A1_FIT(rxdesc)
#define GET_RX_DESC_MACID_RPT_BUFF_8723F(rxdesc)    GET_RX_DESC_MACID_RPT_BUFF(rxdesc)
#define GET_RX_DESC_RX_PRE_NDP_OK_8723F(rxdesc)    GET_RX_DESC_RX_PRE_NDP_OK(rxdesc)
#define GET_RX_DESC_RX_SCRAMBLER_8723F(rxdesc)    GET_RX_DESC_RX_SCRAMBLER(rxdesc)
#define GET_RX_DESC_RX_EOF_8723F(rxdesc)    GET_RX_DESC_RX_EOF(rxdesc)
#define GET_RX_DESC_FC_POWER_8723F(rxdesc)    GET_RX_DESC_FC_POWER(rxdesc)
#define GET_RX_DESC_TXRPT_MID_CTL_MASK_8723F(rxdesc)    GET_RX_DESC_TXRPT_MID_CTL_MASK(rxdesc)

/*RXDESC_WORD5*/

#define GET_RX_DESC_TSFL_8723F(rxdesc)    GET_RX_DESC_TSFL(rxdesc)
...
#define GET_RX_DESC_EOR_8735B(rxdesc)    GET_RX_DESC_EOR(rxdesc)
#define GET_RX_DESC_PHYPKTIDC_8735B(rxdesc)    GET_RX_DESC_PHYPKTIDC(rxdesc)
#define GET_RX_DESC_SWDEC_8735B(rxdesc)    GET_RX_DESC_SWDEC(rxdesc)
#define GET_RX_DESC_PHYST_8735B(rxdesc)    GET_RX_DESC_PHYST(rxdesc)
#define GET_RX_DESC_SHIFT_8735B(rxdesc)    GET_RX_DESC_SHIFT(rxdesc)
#define GET_RX_DESC_QOS_8735B(rxdesc)    GET_RX_DESC_QOS(rxdesc)
#define GET_RX_DESC_SECURITY_8735B(rxdesc)    GET_RX_DESC_SECURITY(rxdesc)
#define GET_RX_DESC_DRV_INFO_SIZE_8735B(rxdesc)    GET_RX_DESC_DRV_INFO_SIZE(rxdesc)
#define GET_RX_DESC_ICV_ERR_8735B(rxdesc)    GET_RX_DESC_ICV_ERR(rxdesc)
#define GET_RX_DESC_CRC32_8735B(rxdesc)    GET_RX_DESC_CRC32(rxdesc)
#define GET_RX_DESC_PKT_LEN_8735B(rxdesc)    GET_RX_DESC_PKT_LEN(rxdesc)

/*RXDESC_WORD1*/

#define GET_RX_DESC_BC_8735B(rxdesc)    GET_RX_DESC_BC(rxdesc)
#define GET_RX_DESC_MC_8735B(rxdesc)    GET_RX_DESC_MC(rxdesc)
#define GET_RX_DESC_TY_PE_8735B(rxdesc)    GET_RX_DESC_TY_PE(rxdesc)
#define GET_RX_DESC_MF_8735B(rxdesc)    GET_RX_DESC_MF(rxdesc)
#define GET_RX_DESC_MD_8735B(rxdesc)    GET_RX_DESC_MD(rxdesc)
#define GET_RX_DESC_PWR_8735B(rxdesc)    GET_RX_DESC_PWR(rxdesc)
#define GET_RX_DESC_PAM_8735B(rxdesc)    GET_RX_DESC_PAM(rxdesc)
#define GET_RX_DESC_CHK_VLD_8735B(rxdesc)    GET_RX_DESC_CHK_VLD(rxdesc)
#define GET_RX_DESC_RX_IS_TCP_UDP_8735B(rxdesc)    GET_RX_DESC_RX_IS_TCP_UDP(rxdesc)
#define GET_RX_DESC_RX_IPV_8735B(rxdesc)    GET_RX_DESC_RX_IPV(rxdesc)
#define GET_RX_DESC_CHKERR_8735B(rxdesc)    GET_RX_DESC_CHKERR(rxdesc)
#define GET_RX_DESC_PAGGR_8735B(rxdesc)    GET_RX_DESC_PAGGR(rxdesc)
#define GET_RX_DESC_RXID_MATCH_8735B(rxdesc)    GET_RX_DESC_RXID_MATCH(rxdesc)
#define GET_RX_DESC_AMSDU_8735B(rxdesc)    GET_RX_DESC_AMSDU(rxdesc)
#define GET_RX_DESC_MACID_VLD_8735B(rxdesc)    GET_RX_DESC_MACID_VLD(rxdesc)
#define GET_RX_DESC_TID_8735B(rxdesc)    GET_RX_DESC_TID(rxdesc)
#define GET_RX_DESC_MACID_8735B(rxdesc)    GET_RX_DESC_MACID(rxdesc)

/*RXDESC_WORD2*/

#define GET_RX_DESC_FCS_OK_8735B(rxdesc)    GET_RX_DESC_FCS_OK(rxdesc)
#define GET_RX_DESC_PPDU_CNT_8735B(rxdesc)    GET_RX_DESC_PPDU_CNT(rxdesc)
#define GET_RX_DESC_C2H_8735B(rxdesc)    GET_RX_DESC_C2H(rxdesc)
#define GET_RX_DESC_HWRSVD_8735B(rxdesc)    GET_RX_DESC_HWRSVD(rxdesc)
#define GET_RX_DESC_WLANHD_IV_LEN_8735B(rxdesc)    GET_RX_DESC_WLANHD_IV_LEN(rxdesc)
#define GET_RX_DESC_RX_STATISTICS_8735B(rxdesc)    GET_RX_DESC_RX_STATISTICS(rxdesc)
#define GET_RX_DESC_RX_IS_QOS_8735B(rxdesc)    GET_RX_DESC_RX_IS_QOS(rxdesc)
#define GET_RX_DESC_FRAG_8735B(rxdesc)    GET_RX_DESC_FRAG(rxdesc)
#define GET_RX_DESC_SEQ_8735B(rxdesc)    GET_RX_DESC_SEQ(rxdesc)

/*RXDESC_WORD3*/

#define GET_RX_DESC_MAGIC_WAKE_8735B(rxdesc)    GET_RX_DESC_MAGIC_WAKE(rxdesc)
#define GET_RX_DESC_UNICAST_WAKE_8735B(rxdesc)    GET_RX_DESC_UNICAST_WAKE(rxdesc)
#define GET_RX_DESC_PATTERN_MATCH_8735B(rxdesc)    GET_RX_DESC_PATTERN_MATCH(rxdesc)
#define GET_RX_DESC_RXPAYLOAD_MATCH_8735B(rxdesc)    GET_RX_DESC_RXPAYLOAD_MATCH(rxdesc)
#define GET_RX_DESC_RXPAYLOAD_ID_8735B(rxdesc)    GET_RX_DESC_RXPAYLOAD_ID(rxdesc)
#define GET_RX_DESC_DMA_AGG_NUM_8735B(rxdesc)    GET_RX_DESC_DMA_AGG_NUM(rxdesc)
#define GET_RX_DESC_BSSID_FIT_1_0_8735B(rxdesc)    GET_RX_DESC_BSSID_FIT_1_0(rxdesc)
#define GET_RX_DESC_EOSP_8735B(rxdesc)    GET_RX_DESC_EOSP(rxdesc)
#define GET_RX_DESC_HTC_8735B(rxdesc)    GET_RX_DESC_HTC(rxdesc)
#define GET_RX_DESC_BSSID_FIT_4_2_8735B(rxdesc)    GET_RX_DESC_BSSID_FIT_4_2(rxdesc)
#define GET_RX_DESC_RX_RATE_8735B(rxdesc)    GET_RX_DESC_RX_RATE(rxdesc)

/*RXDESC_WORD4*/

#define GET_RX_DESC_A1_FIT_8735B(rxdesc)    GET_RX_DESC_A1_FIT(rxdesc)
#define GET_RX_DESC_MACID_RPT_BUFF_8735B(rxdesc)    GET_RX_DESC_MACID_RPT_BUFF(rxdesc)
#define GET_RX_DESC_RX_PRE_NDP_VLD_8735B(rxdesc)    GET_RX_DESC_RX_PRE_NDP_VLD(rxdesc)
#define GET_RX_DESC_RX_SCRAMBLER_8735B(rxdesc)    GET_RX_DESC_RX_SCRAMBLER(rxdesc)
#define GET_RX_DESC_RX_EOF_8735B(rxdesc)    GET_RX_DESC_RX_EOF(rxdesc)
#define GET_RX_DESC_PATTERN_IDX_8735B(rxdesc)    GET_RX_DESC_PATTERN_IDX(rxdesc)

/*RXDESC_WORD5*/

#define GET_RX_DESC_TSFL_8735B(rxdesc)    GET_RX_DESC_TSFL(rxdesc)
