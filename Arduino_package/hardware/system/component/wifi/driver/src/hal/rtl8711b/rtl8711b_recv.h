 ...
 *
 ******************************************************************************/
#ifndef __RTL8711B_RECV_H__
#define __RTL8711B_RECV_H__

#ifdef CONFIG_WLAN_HAL_TEST
#define MAX_RECVBUF_SZ	1500//(RX_DMA_SIZE_8711B - RX_DMA_RESERVED_SIZE_8711B)
#else
#if (SKB_PRE_ALLOCATE_RX==1)
#define MAX_RECVBUF_SZ	MAX_SKB_BUF_SIZE //1650 //(RX_DMA_SIZE_8711B - RX_DMA_RESERVED_SIZE_8711B)
#else
...
s32 rtl8711b_init_recv_priv(PADAPTER padapter);
void rtl8711b_free_recv_priv(PADAPTER padapter);
void rtl8711b_query_rx_desc_status(union recv_frame *precvframe, u8 *pdesc);
void rtl8711b_query_rx_phy_status(union recv_frame	*precvframe, u8 *pphy_status);
