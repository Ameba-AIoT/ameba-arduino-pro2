 ...
 * 
 *****************************************************************************/
#ifndef __INC_HAL8711BREG_H
#define __INC_HAL8711BREG_H
...
#define REG_TDECTRL1_8711B				0x0228
...
#define REG_AMPDU_MAX_LENGTH_8711B	0x0458
...
#define	GPIO_IO_SEL					(REG_GPIO_PIN_CTRL_8711+2)	// GPIO pins output enable when a bit is set to "1"; otherwise, input is configured.
...
//----------------------------------------------------------------------------
//       8711 (MSR) Media Status Register	(Offset 0x4C, 8 bits)  
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
#if 0
#define	IMR_WL_FTINT_MSK_8711B                BIT31       //The interrupt mask from WL page 1 interrupt source		
#define	IMR_P2P_RFOFF_INT_MSK_8711B           BIT9        //P2P NoA RF off time indication interrupt mask
#define	IMR_P2P_RFON_INT_MSK_8711B            BIT8        //P2P NoA RF on time indication interrupt mask
#define	IMR_PSTIMER_MSK_8711B                 BIT6        //Enable PSTimer interrupt source
#define	IMR_TIMEOUT1_MSK_8711B                BIT5        //Enable Timer1 interrupt source
#define	IMR_TIMEOUT0_MSK_8711B                BIT4        //Enable Timer0 interrupt source
#define	IMR_MTI_BCNIVLEAR_INT_MSK_8711B       BIT1        //Enable MTI_BCNIVLEAR _INT
...
#define	IMR_TXFOVW_MSK_8711B	        BIT18        //"Transmit packet buffer Overflow.This bit is set to 1 when one or more of the hardware transmit queues is full"

#define	IMR_TSF_BIT32_TOGGLE_MSK_V1_8711B     BIT17       //Enable TSF_BIT32_TOGGLE interrupt source

#define	IMR_CTWEndINT_MSK_8711B	        BIT13        //This bit masks the CTWindow End interrupt.

#define	IMR_BCNDMA9_MSK_8711B	        BIT9       //When BCNDMA interval arrives before TBTT9,
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA8_MSK_8711B	        BIT8       //When BCNDMA interval arrives before TBTT8,
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA7_MSK_8711B	        BIT7       //When BCNDMA interval arrives before TBTT7,
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA6_MSK_8711B	        BIT6       //When BCNDMA interval arrives before TBTT6,
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA5_MSK_8711B	        BIT5       //When BCNDMA interval arrives before TBTT5, 
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA4_MSK_8711B	        BIT4       //When BCNDMA interval arrives before TBTT4,
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA3_MSK_8711B	        BIT3       //When BCNDMA interval arrives before TBTT3,
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA2_MSK_8711B	        BIT2       //When BCNDMA interval arrives before TBTT2, 
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA1_MSK_8711B	        BIT1        //When BCNDMA interval arrives before TBTT1, 
                                                    //this interrupt informs MCU to prepare related beacon tasks.
#define	IMR_BCNDMA0_MSK_8711B	        BIT0        //When BCNDMA interval arrives before TBTT0, 
                                                    //this interrupt informs MCU to prepare related beacon tasks.
...
//----------------------------------------------------------------------------
#define	IMR_SOUND_DONE_MSK_8711B        BIT30       //Be a beamformer, this interrupt is issued at the time after sounding finish
#define	IMR_TRY_DONE_MSK_8711B          BIT29       //When TRY_FINISH is deasserted, this interrupt is issued to inform MCU
#define	IMR_TXRPT_CNT_FULL_MSK_8711B    BIT28
#define	IMR_WLACTOFF_INT_EN_8711B       BIT27
#define	IMR_WLACTON_INT_EN_8711B        BIT26
#define	IMR_TXPKTIN_INT_EN_8711B        BIT25	
#define	IMR_RX_UMD0_EN_8711B            BIT22
#define	IMR_RX_UMD1_EN_8711B            BIT21
#define	IMR_RX_BMD0_EN_8711B            BIT20
#define	IMR_RX_BMD1_EN_8711B            BIT19
#define	IMR_BCN_RX_INT_EN_8711B         BIT18
#define	IMR_TBTTINT_MSK_8711B           BIT17

#define	IMR_STBY_MSK_8711B	            BIT7        //Lower Power Standby Interrupt mask
#define	IMR_RXDONE_MSK_8711B	        BIT3        //Rx Packet done for 8051
#define	IMR_ERRORHDL_MSK_8711B	        BIT2        //FWHW/ TXDMA/ RXDMA/ WMAC error status interrupt
#define	IMR_TXCCX_MSK_FW_8711B	        BIT1        //CCX PKT TX Report Interrupt
...
//----------------------------------------------------------------------------
#define	IMR_BCNDERR7_8711B				BIT31		// Beacon Queue DMA Error
#define	IMR_BCNDERR6_8711B				BIT30		// Beacon Queue DMA Error
#define	IMR_BCNDERR5_8711B				BIT29		// Beacon Queue DMA Error
#define	IMR_BCNDERR4_8711B				BIT28		// Beacon Queue DMA Error
#define	IMR_BCNDERR3_8711B				BIT27		// Beacon Queue DMA Error
#define	IMR_BCNDERR2_8711B				BIT26		// Beacon Queue DMA Error
#define	IMR_BCNDERR1_8711B				BIT25		// Beacon Queue DMA Error
#define	IMR_BCNDERR0_8711B				BIT24		// Beacon Queue DMA Error
#define	IMR_BCNDMAOK7_8711B				BIT23		// Beacon DMA OK Interrupt 7
#define	IMR_BCNDMAOK6_8711B				BIT22		// Beacon DMA OK Interrupt 6
#define	IMR_BCNDMAOK5_8711B				BIT21		// Beacon DMA OK Interrupt 5
#define	IMR_BCNDMAOK4_8711B				BIT20		// Beacon DMA OK Interrupt 4
#define	IMR_BCNDMAOK3_8711B				BIT19		// Beacon DMA OK Interrupt 3
#define	IMR_BCNDMAOK2_8711B				BIT18		// Beacon DMA OK Interrupt 2
#define	IMR_BCNDMAOK1_8711B				BIT17		// Beacon DMA OK Interrupt 1
#define	IMR_BCNDMAOK0_8711B				BIT16		// Beacon DMA OK Interrupt 0
#define	IMR_H7DOK_8711B					BIT15		// High Queue DMA OK Interrup 7
#define	IMR_H6DOK_8711B					BIT14		// High Queue DMA OK Interrup 6
#define	IMR_H5DOK_8711B					BIT13		// High Queue DMA OK Interrup 5
#define	IMR_H4DOK_8711B					BIT12		// High Queue DMA OK Interrup 4
#define	IMR_H3DOK_8711B					BIT11		// High Queue DMA OK Interrup 3
#define	IMR_H2DOK_8711B					BIT10		// High Queue DMA OK Interrup 2
#define	IMR_H1DOK_8711B					BIT9		// High Queue DMA OK Interrup 1
#define	IMR_H0DOK_8711B					BIT8		// High Queue DMA OK Interrup 1
#define	IMR_MGNTDOK_8711B				BIT6			// Management Queue DMA OK	
#define	IMR_BKDOK_8711B                 BIT5			// AC_BK DMA OK		
#define	IMR_BEDOK_8711B                 BIT4			// AC_BE DMA OK	
#define	IMR_VIDOK_8711B                 BIT3			// AC_VI DMA OK		
#define	IMR_VODOK_8711B                 BIT2			// AC_VO DMA OK	
#define	IMR_RDU_8711B                   BIT1			// Rx Descriptor Unavailable	
#define	IMR_ROK_8711B                   BIT0			// Receive DMA OK
...
*/
#endif // #ifndef __INC_HAL8711BREG_H
