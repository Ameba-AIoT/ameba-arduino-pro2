 ...
 *
 *******************************************************************************/
#ifndef __RTL8710C_SPEC_H__
#define __RTL8710C_SPEC_H__

#include <autoconf.h>
#if defined(RTW_HALMAC)
#include <hal_halmac.h>	// HALMAC_EFUSE_SIZE_8710C
#else
#include "hal_reg_8710c.h"
#include "hal_bit_8710c.h"
#endif
...
//#define EFUSE_MAP_SIZE		HALMAC_EFUSE_SIZE_8710C

#define MACID_NUM_8710C	128
#define NSS_NUM_8710C		1
#define HW_PORT_NUM_8710C	5
...
#if 0 //redefined in hal_com_reg.h
...
#define RXERR_COUNTER_MASK		BIT_MASK_RPT_COUNTER_8710C
#define RXERR_RPT_RST			BIT_RXERR_RPT_RST_8710C
#define _RXERR_RPT_SEL(type)		(BIT_RXERR_RPT_SEL_V1_3_0_8710C(type) \
		| ((type & 0x10) ? BIT_RXERR_RPT_SEL_V1_4_8710C : 0))
#endif
 ...
 * **************************************************** */
#define	EEPROM_TX_PWR_INX_8710C				0x20
#define	EEPROM_CHANNEL_PLAN_8710C			0xC8
#define	EEPROM_XTAL_8710C					0xC9
#define	EEPROM_THERMAL_METER_8710C			0xCA
#define	EEPROM_IQK_LCK_8710C				0xCB
#define	EEPROM_2G_5G_PA_TYPE_8710C			0xCC
#define	EEPROM_2G_LNA_TYPE_GAIN_SEL_AB_8710C	0xCD
#define	EEPROM_2G_LNA_TYPE_GAIN_SEL_CD_8710C	0xCE
//#define EEPROM_TX_KFREE_8710C				0xEE //not available for 8710C?
//#define EEPROM_THERMAL_OFFSET_8710C			0xEF //not available for 8710C?
#define	EEPROM_MAC_ADDR_8710C				0x11A
#define	EEPROM_RF_BOARD_OPTION_8710C		0x131
#define	EEPROM_FEATURE_OPTION_8710C			0x132 /* 0xC2 */
#define	EEPROM_RF_BT_SETTING_8710C			0x133
#define	EEPROM_VERSION_8710C				0x134
#define	EEPROM_CUSTOMER_ID_8710C			0x135
#define	EEPROM_TX_BBSWING_2G_8710C			0x136
#define	EEPROM_RF_POWER_SAVE_MODE_8710C			0x137
#define	EEPROM_TX_PWR_CALIBRATE_RATE_8710C	0x138
#define	EEPROM_RF_ANTENNA_OPT_8710C			0x139
#define	EEPROM_RFE_OPTION_8710C				0x13A
#define EEPROM_COUNTRY_CODE_8710C			0x13B

#define	EEPROM_PACKAGE_TYPE_8710C				0x1F8 /*from physical map*/
