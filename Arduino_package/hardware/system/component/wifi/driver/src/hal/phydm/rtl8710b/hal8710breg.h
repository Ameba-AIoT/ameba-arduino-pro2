 ...
 *
 *****************************************************************************/
#ifndef __INC_HAL8710BREG_H
#define __INC_HAL8710BREG_H

/* ************************************************************
 *
 * ************************************************************ */

/* 0x0000 ~ 0x01FFh  SysOn Reg definition  */
/* must read/write by indirect way by CM4, HAL_QuerySYSOnReg_8710B() and HAL_SetSYSOnReg_8710B() */
...
#define REG_WL_CLK_CTRL_8710B 0x0002 /* 2 Byte*/
#define REG_SYS_FUNC_EN_8710B 0x0004 /* 2 Byte*/
#define REG_SYS_CLKR_8710B 0x0008 /* 2 Byte*/
#define REG_SYS_EEPROM_CTRL_8710B 0x00E0 /* 2 Byte*/ /*20161103 JJ modified from 0x000A to 0x00E0*/
#define REG_AFE_CTRL_8710B 0x0050
#define REG_WL_RF_PSS_8710B 0x005C /*20161125 JJ add*/
#define REG_EFUSE_INDIRECT_CTRL_8710B 0x006C
#define REG_WL_PIN_FUNC_CTRL_8710B 0x0070
#define REG_HIMR0_8710B 0x0080
#define REG_HISR0_8710B 0x0084
#define REG_HCI_OPT_CTRL_8710B 0x0088
#define REG_8051FW_CTRL_V1_8710B 0x0090
#define REG_USB_HOST_INDIRECT_DATA_8710B 0x009C
#define REG_WL_STATUS_8710B 0x00F0
#define REG_FW_DBG_STATUS_8710B 0x00F4
#define REG_USB_HOST_INDIRECT_ADDR_8710B 0x00F8
#define REG_SYS_CFG2_8710B 0x00FC
 ...
 *
 * ----------------------------------------------------- */
#define REG_CR_8710B 0x0100
#define REG_PBP_8710B 0x0104 /* ?????? */
#define REG_PKT_BUFF_ACCESS_CTRL_8710B 0x0106 /* ?????? */
#define REG_TRXDMA_CTRL_8710B 0x010C
#define REG_TRXFF_BNDY_8710B 0x0114
#define REG_RXFF_PTR_8710B 0x011C
#define REG_CPWM_8710B 0x012C
#define REG_FWIMR_8710B 0x0130
#define REG_FWISR_8710B 0x0134
#define REG_FTIMR_8710B 0x0138
#define REG_PKTBUF_DBG_CTRL_8710B 0x0140
#define REG_RXPKTBUF_CTRL_8710B 0x0142 /* ?????? */
#define REG_PKTBUF_DBG_DATA_L_8710B 0x0144
#define REG_PKTBUF_DBG_DATA_H_8710B 0x0148

#define REG_TC0_CTRL_8710B 0x0150
#define REG_TC1_CTRL_8710B 0x0154
#define REG_TC2_CTRL_8710B 0x0158
#define REG_TC3_CTRL_8710B 0x015C
#define REG_TC4_CTRL_8710B 0x0160
#define REG_TCUNIT_BASE_8710B 0x0164
#define REG_RSVD3_8710B 0x0168 /* ????? */

#define REG_C2HEVT_MSG_NORMAL_8710B 0x01A0 /* ?????? */
#define REG_C2HEVT_CMD_SEQ_88XX 0x01A1 /* ?????? */
#define REG_C2hEVT_CMD_CONTENT_88XX 0x01A2 /* ?????? */ /* JJ modified 20161111 */
#define REG_C2HEVT_CMD_LEN_88XX 0x01AE /* ?????? */
#define REG_C2HEVT_CLEAR_8710B 0x01AF /* ?????? */
#define REG_MCUTST_1_8710B 0x01C0
#define REG_MCUTST_2_8710B 0x01C4
#define REG_MCUTST_WOWLAN_8710B 0x01C7 /* ?????? */
...
#define REG_RXPKT_NUM_8710B 0x0284 /* The number of packets in RXPKTBUF. */
#define REG_RXDMA_CONTROL_8710B 0x0286 /* ?????? Control the RX DMA. */
#define REG_RXDMA_STATUS_8710B 0x0288
#define REG_RXDMA_PRO_8710B 0x0290 /* ?????? */
...
#define REG_PTCL_POLL_MGN_8710B 0x041F
#define REG_FWHW_TXQ_CTRL_8710B 0x0420
#define REG_HWSEQ_CTRL_8710B 0x0423
#define REG_BCNQ_BDNY_8710B 0x0424
#define REG_MGQ_BDNY_8710B 0x0425
#define REG_LIFETIME_EN_8710B 0x0426
#define REG_FW_FREE_TAIL_8710B 0x0427
#define REG_SPEC_SIFS_8710B 0x0428
#define REG_RETRY_LIMIT_8710B 0x042A
...
#define REG_BCNQ2_BDNY_8710B 0x0455
#define REG_AMPDU_MAX_TIME_8710B 0x0456
#define REG_BCNQ1_BDNY_8710B 0x0457
#define REG_AMPDU_MAX_LENGTH_8710B 0x0458
#define REG_WMAC_LBK_BUF_HD_8710B 0x045D
...
#define REG_PTCL_SDF_STATUS_8710B 0x04BB
#define REG_SW_AMPDU_BURST_MODE_CTRL_8710B 0x04BC
#define REG_EVTQ_BNDY_8710B 0x04BF
#define REG_PKT_LIFE_TIME_8710B 0x04C0
...
#define REG_MACID_SLEEP2_8710B 0x04D0
#define REG_PTCL_HWSSN0_8710B 0x04D8
#define REG_TXPKTBUF_WMAC_LBK_BF_HD_8710B 0x045D /* ?????? */

/************* 0x1480~0x14A7 is for NAN ***************/
/* Own Master Rank, 8Bytes */
#define REG_NAN_INTERFACE_ADDR_8710B 0x2480 /* 6 bytes */
#define REG_NAN_RANDOM_FACTOR_8710B 0x2486 /* 1 byte */
#define REG_NAN_MASTER_PREF_8710B 0x2487 /* 1 byte */

/* 0x5dc[25:24] NAN role */

/* Current Anchor Master Record */
#define REG_NAN_CAMR_L_8710B 0x2488 /* 4 bytes */
#define REG_NAN_CAMR_H_8710B 0x248C /* 4 byte
 * #define REG_HOP_CNT_8710B					0x05DC */
#define REG_NAN_CAMR_AMBTT_8710B 0x2490 /* 4 bytes */

/* Last Anchor Master Record */
#define REG_NAN_LAMR_L_8710B 0x2494 /* 4 bytes */
#define REG_NAN_LAMR_H_8710B 0x2498 /* 4 byte */
#define REG_NAN_LAMR_AMBTT_8710B 0x249C /* 4 bytes */

/* TSF Synced:bit 0
 * Anchor Master: bit 7 */
#define REG_NAN_STATUS_8710B 0x24A0 /* BIT0
 ***************************************************/
...
#define REG_EDCA_BCNCTRL1_IOREG_8710B 0x0551
...
#define REG_TSFTR2_8710B 0x0578
#define REG_PSTIMER_8710B 0x0580
#define REG_TIMER0_8710B 0x0584
#define REG_TIMER1_8710B 0x0588
#define REG_SCH_MULTI_BCN_8710B 0x05B2
#define REG_SCH_CURRENT_BCN_8710B 0x05B3
#define REG_ACMHWCTRL_8710B 0x05C0
#define REG_SCH_SDFX_EARLY_8710B 0x05CF
#define REG_SCH_PORT2_EARLY_8710B 0x05D0
#define REG_SCH_TSFT_DIFF_8710B 0x05D2
#define REG_EDCA_BCNCTRL2_IOREG_8710B 0x05D4
#define REG_EDCA_DRVERLYINT1_IOREG_8710B 0x05D4
#define REG_EDCA_BCNSPACE3_IOREG_8710B 0x05D8
#define REG_EDCA_BCNSPACE4_IOREG_8710B 0x05DA
#define REG_HOP_CNT_8710B 0x05DC
#define REG_SCH_M_DW_8710B 0x05DD
#define REG_SCH_M_SLOT_8710B 0x05DE
#define REG_SCH_EARLY_DWEND_8710B 0x05DF
...
#define REG_NAV_UPPER_8710B 0x0652 /* ?????? */
...
#define REG_ASSOCIATED_BFMER0_INFO_8710B 0x06E4
#define REG_ASSOCIATED_BFMER1_INFO_8710B 0x06EC
...
#define REG_ASSOCIATED_BFMEE_SEL_8710B 0x0714
#define REG_SND_PTCL_CTRL_8710B 0x0718
#define REG_PORT_CONTROL_8710B 0x76D
/* -----------------------------------------------------
 *
...
#define MSR_8710B (REG_CR_8710B + 2) /* Media status register */
#define ISR_8710B REG_HISR0_8710B
#define TSFR_8710B REG_TSFTR_8710B /* Timing Sync Function Timer Register. */

/* Redifine MACID register, to compatible prior ICs. */
#define IDR0_8710B REG_MACID_8710B /* MAC ID Register, Offset 0x0050-0x0053 */
#define IDR4_8710B (REG_MACID_8710B + 4) /* MAC ID Register, Offset 0x0054-0x0055 */

/*
 * 9. security Control Registers	(Offset: )
 *   */
#define RWCAM_8710B REG_CAMCMD_8710B /* 8190 data Sheet is called CAMcmd */
#define WCAMI_8710B REG_CAMWRITE_8710B /* Software write CAM input content */
#define RCAMO_8710B REG_CAMREAD_8710B /* Software read/write CAM config */
#define CAMDBG_8710B REG_CAMDBG_8710B
#define SECR_8710B REG_SECCFG_8710B /* security Configuration Register */

/* ----------------------------------------------------------------------------
 * 8195 IMR/ISR bits						(offset 0xB0,  8bits)
 * ---------------------------------------------------------------------------- */
#define IMR_DISABLED_8710B 0
/* IMR DW0(0x00B0-00B3) Bit 0-31 */
/* JJ modified 20161111 */
#define IMR_WLMCU_ERR_8710B BIT(29) /* dw8051 error */
#define IMR_EVNTQ_DONE_8710B BIT(28) /* event queue done for NAN */
#define IMR_EVNTQ_START_8710B BIT(27) /* event queue start for NAN */
#define IMR_FWMSG_8710B BIT(26) /* FW message */
#define IMR_HCPWM2_8710B BIT(25) /* CPWM2 */
#define IMR_HCPWM_8710B BIT(24) /* CPWM */
#define IMR_RXFF_FULL_8710B BIT(23) /* rxpktbuffer full */
#define IMR_RDE_ERR_8710B BIT(22) /* Rxdma error */
#define IMR_TDE_ERR_8710B BIT(21) /* Txdma error */
#define IMR_TXBCN0ERR_8710B BIT(20) /* port0 tx beacon err */
#define IMR_TXBCN0OK_8710B BIT(19) /* port0 tx beacon ok */
#define IMR_TXFF_FIFO_8710B BIT(18) /* txpktbuffer full interrupt */
#define IMR_TSF_BIT32_TOGGLE_8710B BIT(17) /* TSF_BIT32_TOGGLE interrupt */
#define IMR_TIMEOUT2_8710B BIT(16) /* timer 2 interrupt */
#define IMR_TIMEOUT1_8710B BIT(15) /* timer 1 interrupt */
#define IMR_TIMEOUT0_8710B BIT(14) /* timer 0 interrupt */
#define IMR_CTWEND_8710B BIT(13) /* client traffic windows end for P2P */
#define IMR_DWWIN_END_8710B BIT(12) /* discovery window end for NAN */
#define IMR_ATIMEND1_8710B BIT(11) /* port1 atimend interrupt */
#define IMR_ATIMEND0_8710B BIT(10) /* port0 atimend interrupt */
#define IMR_BCNERLY9_8710B BIT(9) /* port2 beacon early interrupt */
#define IMR_BCNERLY8_8710B BIT(8) /* port1 beacon early interrupt */
#define IMR_BCNERLY7_8710B BIT(7) /* port 0 BSSID7 beacon earuly interrupt */
#define IMR_BCNERLY6_8710B BIT(6) /* port 0 BSSID6 beacon earuly interrupt */
#define IMR_BCNERLY5_8710B BIT(5) /* port 0 BSSID5 beacon earuly interrupt */
#define IMR_BCNERLY4_8710B BIT(4) /* port 0 BSSID4 beacon earuly interrupt */
#define IMR_BCNERLY3_8710B BIT(3) /* port 0 BSSID3 beacon earuly interrupt */
#define IMR_BCNERLY2_8710B BIT(2) /* port 0 BSSID2 beacon earuly interrupt */
#define IMR_BCNERLY1_8710B BIT(1) /* port 0 BSSID1 beacon earuly interrupt */
#define IMR_BCNERLY0_8710B BIT(0) /* port0 root bssid before TBTT time set by DRVERLYINT */
/*===================================================================
=====================================================================
...
/* JJ modified 20161111 */
/* 2 ACMHWCTRL 0x05C0 */
#define AcmHw_HwEn_8710B BIT(0)
#define AcmHw_VoqEn_8710B BIT(1)
#define AcmHw_ViqEn_8710B BIT(2)
#define AcmHw_BeqEn_8710B BIT(3)
#define AcmHw_VoqStatus_8710B BIT(5)
#define AcmHw_ViqStatus_8710B BIT(6)
#define AcmHw_BeqStatus_8710B BIT(7)
...
#endif /*  #ifndef __INC_HAL8710BREG_H */
