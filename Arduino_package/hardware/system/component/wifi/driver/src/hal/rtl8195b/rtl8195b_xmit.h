 ...
 *
 ******************************************************************************/
#ifndef _RTL8195BA_XMIT_H_
#define _RTL8195BA_XMIT_H_
...
s32 rtl8195ba_init_xmit_priv(PADAPTER);
void rtl8195ba_free_xmit_priv(PADAPTER);
s32 rtl8195ba_hal_xmitframe_enqueue(PADAPTER, struct xmit_frame *pxmitframe);
s32 rtl8195ba_hal_xmit(PADAPTER, struct xmit_frame *pxmitframe);
s32 rtl8195ba_mgnt_xmit(PADAPTER, struct xmit_frame *pxmitframe);
struct xmit_buf *rtl8195b_dequeue_xmitbuf(struct rtw_tx_ring *ring);

//s32 rtl8195ba_xmit_buf_handler(PADAPTER);
//thread_return rtl8195ba_xmit_thread(thread_context);

#endif /* _RTL8195BA_XMIT_H_ */
