...
void halbb_gpio_setting_8730e(struct bb_info *bb, u8 gpio_idx,
							  enum bb_path path, bool inv,
							  enum bb_rfe_src_sel src);

void halbb_gpio_setting_all_8730e(struct bb_info *bb, u8 rfe_idx);

void halbb_gpio_setting_init_8730e(struct bb_info *bb);
...
bool halbb_direct_write_rf_reg_8730e(struct bb_info *bb, enum rf_path path, u32 reg_addr,
					  u32 bit_mask, u32 data);

bool halbb_write_rf_reg_8730e(struct bb_info *bb, enum rf_path path, u32 reg_addr,
			      u32 bit_mask, u32 data);
...
void halbb_tssi_bb_reset_8730e(struct bb_info *bb);
...
bool halbb_ctrl_ch2_80p80_8730e(struct bb_info *bb, u8 central_ch);
...
void halbb_set_tx_pow_ref_8730e(struct bb_info *bb, s16 pw_dbm_ofdm,
