...
#define PS_TUNING_PARA_SET_PS_TIME_OUT_EXT(h2c_pkt, value)                     \
	SET_H2C_FIELD_CLR(h2c_pkt + 0X04, 16, 7, value)
#define PS_TUNING_PARA_SET_PS_TIME_OUT_EXT_EN(h2c_pkt, value)                  \
	SET_H2C_FIELD_CLR(h2c_pkt + 0X04, 23, 1, value)
#define PS_TUNING_PARA_GET_RX_BCN_LIMIT(h2c_pkt) \
	LE_BITS_TO_4BYTE(h2c_pkt + 0X04, 24, 8)
