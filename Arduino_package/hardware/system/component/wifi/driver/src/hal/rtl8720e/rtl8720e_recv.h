 ...
 *
 ******************************************************************************/
#ifndef __RTL8720E_RECV_H__
#define __RTL8720E_RECV_H__

#ifdef CONFIG_WLAN_HAL_TEST
#define MAX_RECVBUF_SZ	1500//(RX_DMA_SIZE_8720E - RX_DMA_RESERVED_SIZE_8720E)
#else
#if (SKB_PRE_ALLOCATE_RX==1)
#define MAX_RECVBUF_SZ	MAX_SKB_BUF_SIZE //1650 //(RX_DMA_SIZE_8720E - RX_DMA_RESERVED_SIZE_8720E)
#else
...
s32 rtl8720e_init_recv_priv(PADAPTER padapter);
void rtl8720e_free_recv_priv(PADAPTER padapter);
void rtl8720e_query_rx_desc_status(struct rx_pkt_attrib *pattrib, u8 *pdesc);
void rtl8720e_query_rx_phy_status(_adapter *padapter, struct rx_pkt_attrib	*pattrib, u8 *physts_ptr);
void rtl8720e_release_physts_readptr(u16 read_ptr);
u8 rtl8720e_manual_fetch_physts(_adapter *padapter, u8 rxbd_idx);
void rtl8720e_set_tsf_timer0(u16 timeout);

#ifdef CONFIG_CSI
void rtl8720e_query_rx_csi_desc(struct rtw_csi_desc *csi_desc, u8 *pdesc);
#endif
#ifdef RTL8720E_WORK_AROUND /*https://jira.realtek.com/browse/AMEBALITE-314*/
void rtl8720e_rx_trig_for_solve_tx_hang(_adapter *padapter, u8 *buf);
#endif
#endif
