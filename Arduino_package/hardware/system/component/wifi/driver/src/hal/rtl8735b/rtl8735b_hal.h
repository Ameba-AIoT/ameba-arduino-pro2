 ...
 *
 ******************************************************************************/
#ifndef _RTL8735B_HAL_H_
#define _RTL8735B_HAL_H_

#include <osdep_service.h>		/* BIT(x) */
#include "halmac_api.h"	/* MAC REG definition */
#include "hal_data.h"
#include "rtl8735b_fw.h"
#include "rtl8735b_spec.h"
#include "rtl8735b_dm.h"
#include "rtl8735b_efuse.h"
#include "rtl8735b.h"
...
void rtl8735b_prepare_mp_txdesc(PADAPTER, struct mp_priv *);	/* rtw_mp.c */
void rtl8735b_mp_config_rfpath(PADAPTER);			/* hal_mp.c */
#endif
void rtl8735b_recv_tasklet(void *priv);
void update_recvframe_phyinfo_8735b(union recv_frame	*precvframe, u8 *pphy_status);

#ifdef CONFIG_WOWLAN
int rtl8735b_suspend(int mode);
int rtl8735b_resume(int mode);
#endif

#endif /* _RTL8735B_HAL_H_ */
