...
#define SENSOR_IMX327         0x05  //  |   v    |   -    |   -    |   v    |
#define SENSOR_F51            0x06  //  |   v    |   v    |   v    |   v    |
#define SENSOR_PS5258         0x07  //  |   v    |   -    |   -    |   -    |  /* don't support multi sensor function */
#define SENSOR_SC301          0x08  //  |   v    |   v    |   -    |   v    |
...
#define SENSOR_F55            0x14  //  |   v    |   -    |   -    |   v    |
#define SENSOR_GC4663         0x15  //  |   v    |   v    |   v    |   v    |
//#define SENSOR_GC4663_HDR   0x16  //  |   v    |   v    |   v    |   v    |  /* use SENSOR_GC4663 with init_hdr_mode = 1 */
#define SENSOR_K351           0x17  //  |   v    |   -    |   -    |   v    |
//#define SENSOR_K351_HDR     0x18  //  |   v    |   -    |   -    |   v    |  /* use SENSOR_GC4663 with init_hdr_mode = 1 */
#define SENSOR_OV50A40        0x19  //  |   v    |   -    |   -    |   -    |
//#define SENSOR_SC301_HDR    0x1A  //  |   v    |   -    |   -    |   -    |  /* use SENSOR_GC4663 with init_hdr_mode = 1 */
//#define SENSOR_F51_HDR      0x1B  //  |   v    |   -    |   -    |   -    |  /* use SENSOR_GC4663 with init_hdr_mode = 1 */
#define SENSOR_OS04A10        0x1C  //  |   v    |   -    |   -    |   -    |
//#define SENSOR_F55_HDR      0x1D  //  |   v    |   -    |   -    |   -    |  /* use SENSOR_GC4663 with init_hdr_mode = 1 */
#define SENSOR_GC1084         0x1E  //  |   v    |   -    |   -    |   -    |
#define SENSOR_SC5356         0x1F  //  |   v    |   -    |   -    |   -    |
#define SENSOR_F38            0x20  //  |   v    |   -    |   -    |   -    |
#define SENSOR_PS5262         0x21  //  |   v    |   -    |   -    |   -    |
#define SENSOR_K05            0x22  //  |   v    |   -    |   -    |   -    |
#define SENSOR_MIS2008        0x23  //  |   v    |   -    |   -    |   -    |
#define SENSOR_NT99236        0x24  //  |   v    |   -    |   -    |   -    |
#define SENSOR_VD550G         0x25  //  |   v    |   -    |   -    |   -    |
#define SENSOR_GC3003         0x26  //  |   v    |   -    |   -    |   -    |
