...
typedef enum _vip_network_property_e {
	...
	/*!< \brief get the information of output of dumped layer. the value is vip_nld_output_t */
	VIP_NETWORK_PROP_GET_LAYER_DUMP_OUTPUT = 74,
...
/*! \brief the ids(nodeId) of layer dump
 * \ingroup group_network
*/
