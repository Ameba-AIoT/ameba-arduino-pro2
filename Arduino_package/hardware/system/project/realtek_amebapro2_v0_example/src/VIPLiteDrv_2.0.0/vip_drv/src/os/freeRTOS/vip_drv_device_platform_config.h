...
#define VIDEO_MEMORY_HEAP_SIZE          ( (uint32_t)__nn_eram_end__ - (uint32_t)__nn_eram_start__ )
...
/* irq line number */
static const vip_uint32_t IRQ_LINE_NUMBER[vpmdCORE_COUNT] = {NN_IRQn}; //{179};


/* the size of VIP SRAM */
static const  vip_uint32_t VIP_SRAM_SIZE[vpmdCORE_COUNT] = {0x20000}; //{0x100000};
...
static const  vip_uint32_t AXI_SRAM_SIZE[vpmdCORE_COUNT] = {0}; //{0x43f000};
